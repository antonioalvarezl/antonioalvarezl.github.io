...
<ul class="content-card-list">
  ...
  <li class="content-card talk-card">
    <span class="talk-date">26 Aug 2026</span>
    <strong class="talk-title">Controllability of the continuity equation for normalizing flows</strong><br>
    <em>Seminar in EDP and Applied Mathematics</em>, Universidade Federal Fluminense (UFF), Brazil (online).
  </li>
...
<ul class="content-card-list">
  ...
  <li class="content-card talk-card">
    <span class="talk-date">27 Aug 2026</span>
    <strong class="talk-title">Perceptrons and localization of attention mean-field landscape</strong><br>
    <em>XI Partial Differential Equations, Optimization, Numerics, and Machine Learning</em>,
    Benasque Science Center, Benasque, Spain.<br>
    Thematic Session of COST Action CA24136: <em>Interactions between Control Theory and Machine Learning</em>.
  </li>

  <li class="content-card talk-card">
    <span class="talk-date">25 Aug 2026</span>
    <strong class="talk-title">Controllability of the continuity equation for normalizing flows</strong><br>
    <em>XI Partial Differential Equations, Optimization, Numerics, and Machine Learning</em>,
    Benasque Science Center, Benasque, Spain.
  </li>
